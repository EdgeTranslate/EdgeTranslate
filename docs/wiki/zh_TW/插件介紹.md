...
* __網頁翻譯__ 
  ...
  我們支持了網頁翻譯，可以直接將整個網頁翻譯成你需要的語言。並且可以自由選用有道網頁翻譯或谷歌網頁翻譯，充分滿足你的翻譯需求。__火狐用戶請看[這裏](./致火狐用戶.md)__
