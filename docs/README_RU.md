...
__Внимание:__ Версия в надстройках Firefox больше не поддерживает перевод страницы. Если вам нужен перевод страницы, пожалуйста, обратитесь [сюда](./docs/wiki/en/ToFirefoxUsers.md).
...
Для сборки расширения необходимо установить [Node.js](https://nodejs.org/).
...
[Локализация](./docs/wiki/en/Localization.md)
